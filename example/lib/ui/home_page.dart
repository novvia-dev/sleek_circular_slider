...
final customWidth = CustomSliderWidths(trackWidth: 40, progressBarWidth: 30, shadowWidth: 50);
...
final CircularSliderAppearance appearance = CircularSliderAppearance(
  ...
  infoProperties: info,
  startAngle: 90,
  // handlerImagePath: AppAssetPaths.dialImage,
  angleRange: 360,
  size: 300.0,
);

final viewModel01 = ExampleViewModel(appearance: appearance, min: 15, max: 49, value: 15, pageColors: [
  Colors.black,
  Colors.black,
]);
...
final viewModel05 =
    ExampleViewModel(appearance: appearance05, min: 0, max: 86400, value: 67459, pageColors: [Colors.black, Colors.black87]);
...
final CircularSliderAppearance appearance08 = CircularSliderAppearance(
    customWidths: customWidth08, customColors: customColors08, size: 230.0, spinnerMode: true, spinnerDuration: 1000);
